 ...
 * and from which meteor-flexiforms users will derive their own controllers when user-defined controllers are needed.
...
ngMeteorForms.meteorFindOne = FlexiModels.meteorFindOne;
ngMeteorForms.meteorFind = FlexiModels.meteorFind;

ngMeteorForms.meteorRetrieveAll = FlexiModels.meteorRetrieveAll;

ngMeteorForms.isMeteorCollection = FlexiSpecs.isMeteorCollection;

ngMeteorForms.defaultMessages = {
...
ngMeteorForms.getDefaultMessage = function(messageType){
    return ngMeteorForms.defaultMessages[messageType] || 'Invalid Entry!';
    //TODO fix this ... add default error message strings!
};
...
var _getCollectionSize = function(field){
    return field.getCollectionSize();
};
